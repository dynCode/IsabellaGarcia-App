...
/***/ "./src/app/services/page-details.service.ts":
/*!**************************************************!*\
  !*** ./src/app/services/page-details.service.ts ***!
  \**************************************************/
/*! exports provided: PageDetailsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PageDetailsService", function() { return PageDetailsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var PageDetailsService = /** @class */ (function () {
    function PageDetailsService(loadingController, router, storage) {
    ...
    // GET CART COUNT //
    PageDetailsService.prototype.getCartCount = function () {
    ...
    PageDetailsService.prototype.subCartCount = function () {
        var oldCount = this.cartCount;
        this.cartCount = oldCount - 1;
        console.log(this.cartCount);
        return this.cartCount;
    };
    PageDetailsService.prototype.showCount = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.cartCount];
            });
    ...
    // GET CURRENT BR //
    PageDetailsService.prototype.getBRPoints = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.storage.ready().then(function (data) {
                    _this.storage.get("user").then(function (data) {
                        _this.currentBR = data[0].brPoints;
                        console.log("DB BR: ", _this.currentBR);
                    });
                    _this.storage.get("cart").then(function (data) {
                        if (data == null || data.length == 0) {
                            _this.finalBR = _this.currentBR;
                        }
                        else {
                            var tempSUM = 0;
                            ...
                            _this.finalBR = _this.currentBR - tempSUM;
                        }
                        _this.storage.set("availableBR", _this.finalBR).then(function () {
                            console.log(_this.finalBR);
                        });
                    });
                });
                return [2 /*return*/, this.finalBR];
            });
        });
    };
    PageDetailsService.prototype.setBRPoints = function (amount) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var tempBR;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                tempBR = this.finalBR;
    ...
    PageDetailsService.prototype.addBRPoints = function (brAmount) {
        console.log("add BR: ", brAmount);
        var oldBR = this.finalBR;
        this.finalBR = oldBR + parseInt(brAmount);
        console.log(this.finalBR);
        return this.finalBR;
    };
    PageDetailsService.prototype.showBRPoints = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.finalBR];
            });
    ...
    PageDetailsService.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
        { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"] }
    ]; };
    PageDetailsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])
    ], PageDetailsService);
    return PageDetailsService;
}());

var userDet = /** @class */ (function () {
    function userDet() {
    }
    return userDet;
}());
var constNewCount = /** @class */ (function () {
    function constNewCount() {
    }
    return constNewCount;
}());
var constSubCount = /** @class */ (function () {
    function constSubCount() {
    }
    return constSubCount;
}());
