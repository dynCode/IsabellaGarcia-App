...
var SpecialsPageModule = /** @class */ (function () {
...
var SpecialsPage = /** @class */ (function () {
    function SpecialsPage(productsService, authenticationService, route, storage, pageDetail) {
    ...
    SpecialsPage.prototype.loadData = function (event) {
        var _this = this;
        setTimeout(function () {
            var id = _this.route.snapshot.paramMap.get('id');
            _this.productsService.loadMoreProductsCat(id, ++_this.page);
            setTimeout(function () {
                var arrayLength = _this.productsService.moreProducts.length;
                for (var i = 0; i < arrayLength; i++) {
                    _this.productsService.products.push(_this.productsService.moreProducts[i]);
                    console.log(_this.productsService.moreProducts[i]);
                }
                console.log('Done');
                event.target.complete();
            }, 10000);
            if (_this.productsService.moreProducts.length == 1000) {
                event.target.disabled = true;
            }
        }, 500);
    };
    SpecialsPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    SpecialsPage.prototype.getProdDet = function (id) {
        this.productsService.ProductDetails(id);
        console.log(this.productsService.productDetails);
    };
    SpecialsPage.prototype.replaceIMG = function (imgString) {
        var newstr = imgString.replace("beta.", "");
        return '<img src="' + newstr + '">';
    };
    SpecialsPage.prototype.searchByKeyword = function () {
...
//# sourceMappingURL=specials-specials-module-es5.js.map