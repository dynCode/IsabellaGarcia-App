...
var LandingPagePage = /** @class */ (function () {
    function LandingPagePage(authenticationService, storage, pageDetail, menu, iab) {
    ...
    LandingPagePage.prototype.ngOnInit = function () {
        ...
        this.storage.ready().then(function (data) {
            _this.storage.get("user").then(function (data) {
                ...
                var browser = _this.iab.create("https://beta.isabellagarcia.co.za/?ig_k=" + _this.userDetails[0].loginKey, '_blank', _this.options);
                browser.hide();
    ...
    LandingPagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_authenticate_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"], _services_page_details_service__WEBPACK_IMPORTED_MODULE_3__["PageDetailsService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["MenuController"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_6__["InAppBrowser"]])
    ], LandingPagePage);
