...
var CategoryPage = /** @class */ (function () {
    function CategoryPage(productsService, route, pageDetail) {
    ...
    CategoryPage.prototype.loadData = function (event) {
        var _this = this;
        setTimeout(function () {
    ...
    CategoryPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    CategoryPage.prototype.getProdDet = function (id) {
        this.productsService.ProductDetails(id);
        console.log(this.productsService.productDetails);
    };
    CategoryPage.prototype.replaceIMG = function (imgString) {
        var newstr = imgString.replace("beta.", "");
        return '<img src="' + newstr + '">';
    };
    CategoryPage.prototype.searchByKeyword = function () {
