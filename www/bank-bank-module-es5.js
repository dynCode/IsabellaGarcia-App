...
var BankPage = /** @class */ (function () {
    function BankPage(productsService, authenticationService, storage, alertController, router, pageDetail) {
    ...
    BankPage.prototype.ngOnInit = function () {
        ...
        this.storage.ready().then(function (data) {
            _this.storage.get("user").then(function (data) {
                ...
                _this.historyList = _this.userDetails[0].history;
            });
        });
    };
    BankPage.ctorParameters = function () { return [
...
//# sourceMappingURL=bank-bank-module-es5.js.map