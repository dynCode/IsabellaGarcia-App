...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(productsService, route, storage, toastController, pageDetail, http) {
        var _this = this;
    ...
    ProductDetailsPage.prototype.ngOnInit = function () {
        ...
        var itemId = parseInt(this.route.snapshot.paramMap.get('id'));
        console.log("Page ID:", itemId);
        this.storage.ready().then(function (data) {
            _this.storage.get("wishlist").then(function (data) {
                if (data == null || data.length == 0) {
                    console.log("Wishlist Empty!");
                    _this.inWishlist = false;
                }
                else {
                    _this.itemIn = data.findIndex(function (x) { return x.id === itemId; });
                    console.log(_this.itemIn);
                    for (var i = 0; i < data.length; i++) {
                        if (itemId === data[i].id) {
                            _this.inWishlist = true;
                            _this.wishlistIndex = i;
                            console.log("Index:", _this.wishlistIndex);
                        }
                    }
                }
            });
    ...
    ProductDetailsPage.prototype.replaceIMG = function (imgString) {
    ...
    ProductDetailsPage.prototype.plusQty = function () {
        this.item_qty++;
        console.log(this.item_qty);
    };
    ProductDetailsPage.prototype.addToCart = function (product, pQty) {
        var _this = this;
        ...
        this.storage.get("cart").then(function (data) {
            if (data == null || data.length == 0) {
                var cartKey = _this.adToUcart(product.id, pQty);
                data = [];
                data.push({
                    "product": product,
                    "qty": pQty,
    ...
    ProductDetailsPage.prototype.uSuccess = function () {
    ...
    ProductDetailsPage.prototype.toggleWishlist = function (product) {
    ...
    ProductDetailsPage.prototype.addWishItem = function (product) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.storage.get("wishlist").then(function (data) {
                    if (data == null || data.length == 0) {
                        data = [];
                        data.push({
                            "product": product,
                    ...
                    _this.storage.set("wishlist", data).then(function () {
                        _this.wishlistIndex = (data.length - 1);
    ...
    ProductDetailsPage.prototype.removeWishItem = function (item, i) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.storage.get("wishlist").then(function (data) {
    ...
    ProductDetailsPage.prototype.ySuccess = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ProductDetailsPage.prototype.adToUcart = function (pid, cqty) {
        var _this = this;
    ...
    ProductDetailsPage.prototype.searchByKeyword = function () {
